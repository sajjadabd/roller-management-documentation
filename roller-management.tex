...
\section{رابطه ها در پایگاه داده}
...
\begin{tikzpicture}
     \node[draw,rectangle] at (0,0) (roll) {
	\text{غلطک}
	};
	\node[draw,rectangle] at (3,-2) (product) {
	\text{محصول}
	};
 	\node[draw,rectangle] at (0,-2) (productionline) {
	\text{
تولید
خط
}
	};
	\node[draw,rectangle] at (-3,0) (stand) {
	\text{استند}
	};
	\node[draw,rectangle] at (-3,-2) (stand) {
	\text{جایگاه}
	};
	\node[draw,rectangle] at (-7,0) (stand) {
	\text{
استند
تعویض
}
	};
	\node[draw,rectangle] at (0,2) (changeroll) {
	\text{
غلطک
تعویض
	}
	};
    \node[draw,rectangle] at (3,0) (calbre) {
	\text{کالیبر}
	};
	\node[draw,rectangle] at (7,1) (tarashcalbre) {
	\text{ 
کالیبر
تراش
	}};
	\node[draw,rectangle] at (7,-1) (changecalbre) {
	\text{ 
کالیبر
تعویض
	}};
